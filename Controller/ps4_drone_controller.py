...
class DroneController:
    ...
    def mavlink_send_loop(self):
        ...
        while self.running:
            if self.master and self.connected and not self.killed:
                try:
                    # Ch5 (AUX1) = 2000 when armed (arm switch high), 1000 otherwise
    ...
    def arm_drone(self):
        ...
        try:
            ...
            # Response will be handled by mavlink_recv_loop
            # which updates self.armed from HEARTBEAT messages
        except Exception as e:
    ...
    def disarm_drone(self):
        ...
        try:
            ...
            # Response handled by mavlink_recv_loop
        except Exception as e:
            self.log(f"Disarm failed: {e}")

    def kill_motors(self):
        """Emergency kill: force disarm."""
        if self.killed:
            return
